        ...
        >
          <div className="p-8 rounded-3xl bg-neutral-900/40 border border-white/10 backdrop-blur-xl">
            <div className="text-center mb-8">
              ...
              <p className="text-neutral-400 text-sm">Enter your credentials to access the neural network.</p>
            </div>
            ...
            <form className="space-y-4">
              ...
              <div>
                <div className="flex items-center justify-between mb-2">
                  <label className="block text-xs font-mono text-neutral-400 uppercase tracking-wider">Password</label>
                  <Link href="#" className="text-xs text-[#FF6B00] hover:text-[#ff8533] transition-colors">Forgot password?</Link>
                </div>
                <input 
                  type="password" 
                  placeholder="••••••••"
            ...
            <p className="text-center text-sm text-neutral-400 mt-8">
              ...
              <Link href="/sign-up" className="text-white hover:text-[#FF6B00] transition-colors font-medium">
                Request Access
              </Link>
            </p>
          </div>
